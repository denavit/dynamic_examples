...
def boltText_output(bolt, UTSs_str,UTSn_str):
    ...
    text.newline(r'$AS_{s,max} = \pi\dfrac{3}{4}D_{1,bsc}LE = \pi\dfrac{3}{4}\left(' + sigfigstr(boltObj.D1bsc) + r'\text{ in.}\right)LE = ' + sigfigstr(boltObj.ASs_max_FEDSTD_6b()) + r'(LE)\text{ in.}^{2}$', tag='p')
    ...
    text.newline(r'$R_{1} = \dfrac{AS_{s,max}}{AS_{n,min}} = \dfrac{' + sigfigstr(boltObj.ASs_max_FEDSTD_6b()) + r'(LE)\text{ in.}^{2}}{' + sigfigstr(boltObj.ASn_min_FEDSTD_2a()) + r'(LE)\text{ in.}^{2}} = ' + sigfigstr(boltObj.ASs_max_FEDSTD_6b()/boltObj.ASn_min_FEDSTD_2a()) + r'$', tag='p')
